...
// gamma_update
Rcpp::List gamma_update(arma::vec radius_range, int exposure_definition_indicator, arma::mat exposure_dists, int p_d, int n_ind, int m, int m_max, int p_w, arma::mat x, arma::mat w, arma::mat v, arma::vec off_set, double sigma2_gamma, arma::vec omega, arma::vec lambda, arma::vec beta, arma::vec eta, arma::vec gamma_old, arma::vec radius, arma::vec theta, arma::vec radius_trans, arma::vec phi_tilde, arma::mat poly, arma::vec exposure, arma::mat Z, arma::vec metrop_var_gamma, arma::vec acctot_gamma);
RcppExport SEXP _EpiBuffer_gamma_update(SEXP radius_rangeSEXP, SEXP exposure_definition_indicatorSEXP, SEXP exposure_distsSEXP, SEXP p_dSEXP, SEXP n_indSEXP, SEXP mSEXP, SEXP m_maxSEXP, SEXP p_wSEXP, SEXP xSEXP, SEXP wSEXP, SEXP vSEXP, SEXP off_setSEXP, SEXP sigma2_gammaSEXP, SEXP omegaSEXP, SEXP lambdaSEXP, SEXP betaSEXP, SEXP etaSEXP, SEXP gamma_oldSEXP, SEXP radiusSEXP, SEXP thetaSEXP, SEXP radius_transSEXP, SEXP phi_tildeSEXP, SEXP polySEXP, SEXP exposureSEXP, SEXP ZSEXP, SEXP metrop_var_gammaSEXP, SEXP acctot_gammaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type radius_range(radius_rangeSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(gamma_update(radius_range, exposure_definition_indicator, exposure_dists, p_d, n_ind, m, m_max, p_w, x, w, v, off_set, sigma2_gamma, omega, lambda, beta, eta, gamma_old, radius, theta, radius_trans, phi_tilde, poly, exposure, Z, metrop_var_gamma, acctot_gamma));
    return rcpp_result_gen;
END_RCPP
}
// latent_update
...
// phi_star_update
Rcpp::List phi_star_update(arma::vec radius_range, int exposure_definition_indicator, arma::mat exposure_dists, int p_d, int n_ind, int n_grid, int m, int m_max, int p_w, arma::mat x, arma::mat w, arma::mat v, arma::vec off_set, arma::vec omega, arma::vec lambda, arma::vec beta, arma::vec eta, arma::vec gamma, arma::vec radius, arma::vec theta, arma::vec radius_trans, arma::vec phi_star, arma::vec phi_tilde, arma::mat phi_star_corr_inv, arma::mat C, arma::mat poly, arma::vec exposure, arma::mat Z, arma::vec metrop_var_phi_star, arma::vec acctot_phi_star);
RcppExport SEXP _EpiBuffer_phi_star_update(SEXP radius_rangeSEXP, SEXP exposure_definition_indicatorSEXP, SEXP exposure_distsSEXP, SEXP p_dSEXP, SEXP n_indSEXP, SEXP n_gridSEXP, SEXP mSEXP, SEXP m_maxSEXP, SEXP p_wSEXP, SEXP xSEXP, SEXP wSEXP, SEXP vSEXP, SEXP off_setSEXP, SEXP omegaSEXP, SEXP lambdaSEXP, SEXP betaSEXP, SEXP etaSEXP, SEXP gammaSEXP, SEXP radiusSEXP, SEXP thetaSEXP, SEXP radius_transSEXP, SEXP phi_starSEXP, SEXP phi_tildeSEXP, SEXP phi_star_corr_invSEXP, SEXP CSEXP, SEXP polySEXP, SEXP exposureSEXP, SEXP ZSEXP, SEXP metrop_var_phi_starSEXP, SEXP acctot_phi_starSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type radius_range(radius_rangeSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(phi_star_update(radius_range, exposure_definition_indicator, exposure_dists, p_d, n_ind, n_grid, m, m_max, p_w, x, w, v, off_set, omega, lambda, beta, eta, gamma, radius, theta, radius_trans, phi_star, phi_tilde, phi_star_corr_inv, C, poly, exposure, Z, metrop_var_phi_star, acctot_phi_star));
    return rcpp_result_gen;
END_RCPP
}
// r_update
...
// rho_phi_update
Rcpp::List rho_phi_update(arma::vec radius_range, int exposure_definition_indicator, arma::mat exposure_dists, int p_d, int n_ind, int n_grid, int m, int m_max, int p_w, arma::mat x, arma::mat w, arma::mat v, arma::vec off_set, arma::mat dists12, arma::mat dists22, double a_rho_phi, double b_rho_phi, arma::vec omega, arma::vec lambda, arma::vec beta, arma::vec eta, arma::vec gamma, arma::vec radius, arma::vec theta, double rho_phi_old, arma::vec radius_trans, arma::vec phi_star, arma::vec phi_tilde, Rcpp::List phi_star_corr_info, arma::mat C, arma::mat poly, arma::vec exposure, arma::mat Z, double metrop_var_rho_phi, int acctot_rho_phi);
RcppExport SEXP _EpiBuffer_rho_phi_update(SEXP radius_rangeSEXP, SEXP exposure_definition_indicatorSEXP, SEXP exposure_distsSEXP, SEXP p_dSEXP, SEXP n_indSEXP, SEXP n_gridSEXP, SEXP mSEXP, SEXP m_maxSEXP, SEXP p_wSEXP, SEXP xSEXP, SEXP wSEXP, SEXP vSEXP, SEXP off_setSEXP, SEXP dists12SEXP, SEXP dists22SEXP, SEXP a_rho_phiSEXP, SEXP b_rho_phiSEXP, SEXP omegaSEXP, SEXP lambdaSEXP, SEXP betaSEXP, SEXP etaSEXP, SEXP gammaSEXP, SEXP radiusSEXP, SEXP thetaSEXP, SEXP rho_phi_oldSEXP, SEXP radius_transSEXP, SEXP phi_starSEXP, SEXP phi_tildeSEXP, SEXP phi_star_corr_infoSEXP, SEXP CSEXP, SEXP polySEXP, SEXP exposureSEXP, SEXP ZSEXP, SEXP metrop_var_rho_phiSEXP, SEXP acctot_rho_phiSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type radius_range(radius_rangeSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(rho_phi_update(radius_range, exposure_definition_indicator, exposure_dists, p_d, n_ind, n_grid, m, m_max, p_w, x, w, v, off_set, dists12, dists22, a_rho_phi, b_rho_phi, omega, lambda, beta, eta, gamma, radius, theta, rho_phi_old, radius_trans, phi_star, phi_tilde, phi_star_corr_info, C, poly, exposure, Z, metrop_var_rho_phi, acctot_rho_phi));
    return rcpp_result_gen;
END_RCPP
}
