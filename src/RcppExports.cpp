...
// phi_star_update
Rcpp::List phi_star_update(arma::vec radius_range, int exposure_definition_indicator, arma::mat v_exposure_dists, int p_q, int n_ind, int n_grid, int m, int m_max, int p_w, arma::mat x, arma::mat q, arma::mat v_w, arma::vec v_index, arma::vec off_set, arma::vec omega, arma::vec lambda, arma::vec beta, arma::vec eta, arma::vec gamma, arma::vec radius, double tau_phi_old, arma::vec radius_trans, arma::vec phi_star, arma::vec phi_tilde, arma::mat phi_star_corr_inv, arma::mat C, arma::vec exposure, arma::mat Z, arma::vec metrop_var_phi_star, arma::vec acctot_phi_star);
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(phi_star_update(radius_range, exposure_definition_indicator, v_exposure_dists, p_q, n_ind, n_grid, m, m_max, p_w, x, q, v_w, v_index, off_set, omega, lambda, beta, eta, gamma, radius, tau_phi_old, radius_trans, phi_star, phi_tilde, phi_star_corr_inv, C, exposure, Z, metrop_var_phi_star, acctot_phi_star));
    return rcpp_result_gen;
END_RCPP
}
// r_update
...
// rho_phi_update
Rcpp::List rho_phi_update(arma::vec radius_range, int exposure_definition_indicator, arma::mat v_exposure_dists, int p_q, int n_ind, int n_grid, int m, int m_max, int p_w, arma::mat x, arma::mat q, arma::mat v_w, arma::vec v_index, arma::vec off_set, arma::mat dists12, arma::mat dists22, double a_rho_phi, double b_rho_phi, arma::vec omega, arma::vec lambda, arma::vec beta, arma::vec eta, arma::vec gamma, arma::vec radius, double tau_phi, double rho_phi_old, arma::vec radius_trans, arma::vec phi_star, arma::vec phi_tilde, Rcpp::List phi_star_corr_info, arma::mat C, arma::vec exposure, arma::mat Z, double metrop_var_rho_phi, int acctot_rho_phi);
